...
class MedicionesTransformadoresSerializer(serializers.ModelSerializer):
    ...
    def perform_calculations(self, validated_data, instance=None ):
        ...
        if(instance != None ):
            history_data = MedicionesTransformadores.objects.exclude(idmediciones_transformadores=instance.idmediciones_transformadores)
        else:
...
class TransformadoresSerializer(serializers.ModelSerializer):
    ...
    idtransformadores = serializers.IntegerField(required=False)
