...
class Pronosticos(models.Model):
    ...
    # Índices calculados del estado actual (de la última medición)
    I_DM = models.DecimalField(max_digits=8, decimal_places=4, null=True, blank=True)
    I_EE = models.DecimalField(max_digits=8, decimal_places=4, null=True, blank=True)
    I_M = models.DecimalField(max_digits=8, decimal_places=4, null=True, blank=True)

    # Memoria histórica
    I_M_prev = models.DecimalField(max_digits=8, decimal_places=4, null=True, blank=True)

    # Tendencia ΔH(t) = IM(t) - IM(t-1)
    delta_IM = models.DecimalField(max_digits=8, decimal_places=4, null=True, blank=True)

    # Probabilidad de mantenimiento Pmant(t)
    Pmant = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)

    # Fecha recomendada para el próximo mantenimiento (calculada a partir de Pmant)
    fecha_recomendada = models.DateField(null=True, blank=True)
...
class PronosticosTransformadores(models.Model):
    ...
    hidrogeno = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    metano = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    etano = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    etileno = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    acetileno = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    dioxido_carbono = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    monoxido_carbono = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    ...
    color = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
